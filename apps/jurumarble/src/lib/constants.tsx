...
export const REGION_LIST = [
  { value: 'SEOUL', label: '서울', lat: 37.53391, long: 126.9775 },
  {
    value: 'INCHEON',
    label: '인천',
    lat: 37.45323333333334,
    long: 126.70735277777779,
  },
  {
    value: 'DAEJEON',
    label: '대전',
    lat: 36.347119444444445,
    long: 127.38656666666667,
  },
  {
    value: 'DAEGU',
    label: '대구',
    lat: 35.868541666666665,
    long: 128.60355277777776,
  },
  {
    value: 'GWANGJU',
    label: '광주',
    lat: 35.156974999999996,
    long: 126.85336388888888,
  },
  {
    value: 'BUSAN',
    label: '부산',
    lat: 35.17701944444444,
    long: 129.07695277777776,
  },
  {
    value: 'ULSAN',
    label: '울산',
    lat: 35.53540833333333,
    long: 129.3136888888889,
  },
  ...
  { value: 'CHUNGBUK', label: '충북', lat: 36.6325, long: 127.49358611111111 },
  {
    value: 'CHUNGNAM',
    label: '충남',
    lat: 36.32387222222223,
    long: 127.42295555555556,
  },
  ...
  { value: 'JEONNAM', label: '전남', lat: 34.813044444444444, long: 126.465 },
  {
    value: 'JEJU',
    label: '제주',
    lat: 33.48569444444445,
    long: 126.50033333333333,
  },
];
