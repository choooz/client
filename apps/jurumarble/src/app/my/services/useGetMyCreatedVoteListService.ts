...
const getMyCreatedVoteQueryKey = (params: GetMyCreatededVoteListServiceProps) => [
  queryKeys.MY_CREATED_VOTE,
  params,
];

export default function useGetMyCreatedVoteListService(params: GetMyCreatededVoteListServiceProps) {
